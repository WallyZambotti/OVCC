...
extern "C"
{
	...
	extern keytranslationentry_t keyTranslationsCoCoSDL[];
	extern keytranslationentry_t keyTranslationsNaturalSDL[];
	extern keytranslationentry_t keyTranslationsCompactSDL[];
